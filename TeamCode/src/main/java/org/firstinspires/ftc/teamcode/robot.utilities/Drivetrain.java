...
public class Drivetrain {
    ...
    public void init(HardwareMap ahwMap) {
        ...
        // Control HUb
        topLeftDriveMotor = hwMap.get(DcMotor.class, "Front_Left");
        bottomLeftDriveMotor = hwMap.get(DcMotor.class, "Rear_Left");
        topRightDriveMotor = hwMap.get(DcMotor.class, "Front_Right");
        bottomRightDriveMotor = hwMap.get(DcMotor.class, "Rear_Right");
