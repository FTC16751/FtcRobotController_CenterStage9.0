...
public class DriverControl2022 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            else if(gamepad2.dpad_up && BelaArm.getCurrentPosition() < maxPosition){
            ...
            else if(gamepad2.dpad_right && BelaArm.getCurrentPosition() < maxPosition){
            ...
            else if (gamepad2.dpad_down && BelaArm.getCurrentPosition() > minPosition){
