 ...
 */
    ...
    public void rotateRight45Degrees() {
        int targetCount;
        double targetSpeed = 0.5;
        double diameter = 47;   //diameter in cms measured between left front and right rear or RF and LR
    ...
    public void rotateLeft45Degrees() {
        int targetCount;
        double targetSpeed = 0.5;
        double diameter = 47;//56.8;   //diameter in cms measured between left front and right rear or RF and LR
